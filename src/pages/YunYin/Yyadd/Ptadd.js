    ...
    <div>
         ...
         {/* 输入框 */}
             <div style={{float:'left',marginLeft:'20px'}}>
                   ...
                   <div style={{float:'left',marginTop:'50px',marginLeft:'-20px',fontSize:'16px'}}>拼团名称</div>
                  <div style={{width:'260px',height:'46px',marginTop:'40px',float:'left',marginLeft:'20px'}}>
                    <Input placeholder="请输入拼团名称" style={{height:'46px'}} />
                  </div>

                  <p style={{float:'left',marginLeft:'-355px',marginTop:'138px',color:'red'}}>*</p>
                   <div style={{float:'left',marginTop:'140px',marginLeft:'-345px',fontSize:'16px'}}>活动名称</div>
